            ...
            {isOpen && (
                ...
                >
                    <nav className="flex flex-col space-y-4 px-8 py-8  text-md">
                        ...
                        <NavLink href="#formacion-salud" number="05">Formación en Teorías para Crear Salud</NavLink>
                        <NavLink href="#limpieza-hepatica" number="06">Salud Orgánica Limpieza Hepática Profunda</NavLink>
